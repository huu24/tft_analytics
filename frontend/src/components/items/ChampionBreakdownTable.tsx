        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-dark-600">
              <th className="text-left py-2 px-3 text-gray-500 font-medium text-xs uppercase tracking-wider">Champion</th>
          ...
          <tbody>
            {sorted.map((c) => {
              ...
              return (
                ...
                >
                  <td className="py-2 px-3 text-gray-200 font-medium">{getDisplayName(c.champion_id)}</td>
